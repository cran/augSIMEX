plotaugSIMEXbr<-function(object,variable,extrapolation=c("both","linear","quadratic"),
    ...
    if (type=="coefficient"|type=="both"){
        ...
        if (extrapolation=="linear"|extrapolation=="both"){
          ...
          if (extrapolation=="linear") {
            legend("bottomright",legend=c("linear"),col=c(2),lty=c(1),lwd=2)
          }
        }
        ...
        if (extrapolation=="quadratic") {
          legend("bottomright",legend=c("quadratic"),col=c(4),lty=c(8),lwd=2)
        } else legend("bottomright",legend=c("linear","quadratic"),col=c(2,4),lty=c(1,8),lwd=2)
      }
